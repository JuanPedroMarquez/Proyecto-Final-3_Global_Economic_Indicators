...
# Definimos la función para introducir un apartado donde enseñamos los resultados de los diferentes modelos de predicción empleados
def predictor():
    ...
    st.title("Eurozone GDP Prediction")
    ...
    # Cargar el modelo ARIMA para comparar      
...
# Definimos la función para mostrar un video al final de la presentación
def video():
